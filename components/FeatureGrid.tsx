...
const FeatureGrid: React.FC<FeatureGridProps> = ({ textColour, hoverColour, iconColour }) => {
	const textColourVariants:  { [key in FeatureGridProps['textColour']]: string } = {
		black: "text-black",
		white: "text-white"
	}
	return (
		<div className="text-gray-300 grid sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
