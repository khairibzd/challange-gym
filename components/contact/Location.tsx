  ...
  return (
    <div className="text-white relative flex flex-col w-full">
      ...
      <div className="relative mt-7 px-4">
        <h4 className="text-black font-bold text-xl uppercase tracking-wide">Address</h4>
        <p>Lorem ipsum dolor sit, amet consectetur</p>
      </div>
      <div className="relative flex flex-col gap-5 md:gap-0 md:flex-row md:justify-between md:items-center mt-5 px-4">
        <div>
          <h4 className="text-black text-xl font-bold uppercase tracking-wide">Phone</h4>
          <p>0203 3333 3333</p>
        </div>
        <div>
          <h4 className="text-black  font-bold  text-xl uppercase tracking-wide">
            Email
          </h4>
